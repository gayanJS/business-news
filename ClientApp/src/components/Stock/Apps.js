...
class Apps extends React.Component{
    ...
    render(){
        ...
        return (
            ...
            <div className={ this.state.showGraphData ? "container-fluid Apps-CONT" : "container-fluid Apps-CONT height-100" }>
                <div className="row Apps-CONT__row">
                    <div className="col-12 Apps-CONT__container">
                        <div className="Apps-CONT__left">
                        ...
                        <div className="Apps-CONT__right">
                            <div className="card card-CONT graph">
